            ...
            <tbody>
                <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                        echo "<tr>";
                        echo "<td>".$user_data['id_compromisso']."</td>";
                        echo "<td>".$user_data['nome']."</td>";
                        echo "<td>".$user_data['descricao']."</td>";
                        echo "<td>".$user_data['data_compromisso']."</td>";
                        echo "<td>
                        <a class='btn btn-sm btn-primary' href='edit.php?id_compromisso=$user_data[id_compromisso]' title='Editar'>
