    ...
    class Aluno
    {
        ...
        public string Classificar
        {
            get
            {
                ...
                else if (indice >= 25 && indice < 30) return "SobrePeso";
                else if (indice >= 30 && indice < 35) return "Obesidade I";
                else if (indice >= 35 && indice < 40) return "Obesidade II !";
                else if (indice >= 40 && indice < 50) return "Obesidade III !!";
